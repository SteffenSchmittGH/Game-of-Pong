 ...
 * @param const sc_joystick_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
static inline RC_t RTE_SC_JOYSTICK_init( SC_JOYSTICK_t * const signal, const SC_JOYSTICK_data_t * const value )
{                                                                                                                      
 ...
 *
 **/
static inline RTE_signalStatus_t RTE_SC_JOYSTICK_getStatus( const SC_JOYSTICK_t * const signal )
{
 ...
 *
 */
static inline RC_t RTE_SC_JOYSTICK_setStatus( SC_JOYSTICK_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
static inline uint32_t RTE_SC_JOYSTICK_getAge( const SC_JOYSTICK_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
static inline void RTE_SC_JOYSTICK_incAge(  SC_JOYSTICK_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 **/
static inline SC_JOYSTICK_data_t RTE_SC_JOYSTICK_get( const SC_JOYSTICK_t * const signal )
{               
 ...
 *
 **/
static inline RC_t RTE_SC_JOYSTICK_getThreadSafe( const SC_JOYSTICK_t * const signal, SC_JOYSTICK_data_t * const data )
{    
 ...
 *
 **/
static inline RC_t RTE_SC_JOYSTICK_set(SC_JOYSTICK_t * const signal, const SC_JOYSTICK_data_t value  )
{
 ...
 *
 */
static inline RC_t RTE_SC_JOYSTICK_pullPort( SC_JOYSTICK_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
 ...
 *
 **/
static inline RC_t RTE_SC_JOYSTICK_pushPort( const SC_JOYSTICK_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
