...
#ifndef SC_MENUE_SIGNAL_H_INCLUDED
#define SC_MENUE_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_MENUE_driverIn_t)(SC_MENUE_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_MENUE_driverOut_t)( const SC_MENUE_data_t * const);
...
/**
 * Instances of the struct SC_MENUE_cfg_t represent the signal object configuration.
 */
struct SC_MENUE_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_MENUE_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_MENUE_driverOut_t const outDriver;
...
typedef const struct SC_MENUE_cfg_s SC_MENUE_cfg_t;
...
/**
 * Instances of the struct SC_MENUE_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const SC_MENUE_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_MENUE_s SC_MENUE_t;
 ...
 *
 * @param  SC_MENUE_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_menue_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
static inline RC_t RTE_SC_MENUE_init( SC_MENUE_t * const signal, const SC_MENUE_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_MENUE_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
static inline RTE_signalStatus_t RTE_SC_MENUE_getStatus( const SC_MENUE_t * const signal )
{
 ...
 *
 */
static inline RC_t RTE_SC_MENUE_setStatus( SC_MENUE_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
static inline uint32_t RTE_SC_MENUE_getAge( const SC_MENUE_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
static inline void RTE_SC_MENUE_incAge(  SC_MENUE_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_MENUE_t * const signal: Pointer to the signal object
 * @return sc_menue_data_t: current value of the application data buffer
 *
 **/
static inline SC_MENUE_data_t RTE_SC_MENUE_get( const SC_MENUE_t * const signal )
{               
 ...
 *
 * @param  SC_MENUE_t * const signal: Pointer to the signal object
 * @param  SC_MENUE_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
static inline RC_t RTE_SC_MENUE_getThreadSafe( const SC_MENUE_t * const signal, SC_MENUE_data_t * const data )
{    
 ...
 *
 * @param  SC_MENUE_t * const signal: Pointer to the signal object
 * @param  sc_menue_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
static inline RC_t RTE_SC_MENUE_set(SC_MENUE_t * const signal, const SC_MENUE_data_t value  )
{
 ...
 *
 */
static inline RC_t RTE_SC_MENUE_pullPort( SC_MENUE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_MENUE_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_MENUE_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_MENUE_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
static inline RC_t RTE_SC_MENUE_pushPort( const SC_MENUE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
